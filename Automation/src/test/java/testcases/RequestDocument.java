...
public class RequestDocument extends AbstractTest {
    ...
    @Test
    public void testCase03CreateRequestDocumentWithEmptyName() throws InterruptedException {
    ...
    @Test
    public void testCase04CreateRequestDocumentSuccess() throws InterruptedException {
        ReportListener.reportLog("Kiểm tra nhập tên tài liệu lớn hơn 255 kí tự ");
        driver.navigate().refresh();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//td[@title='Thêm danh sách hỗ trợ']")).click();
